/* ============================================================
 * 车间产出分析页 v17 - 成品口径与历史日期回看 (独立模块, 零侵入主看板)
 * 叙事主线: 历史经营分析 + 班次效率专题
 *
 * 口径(用户 2026-09-02 确认):
...
(function () {
  ...
  var WS_MAP = [
    ...
    { ws: "Pro.4", tag: "", lines: ["C-Shaft Body A", "C-Shaft Body B", "C-Shaft Pin A", "C-Shaft Pin C", "C-Shft Pin B", "Piston Grinding", "Rod Pispin", "Frame Honing FL", "Frame No.1", "Frame No.2", "Frame No.3", "Frame No.4", "Frame No.5"] },
...
"#anaRoot .hc-modal #anaTable{max-width:560px;margin:0 auto}",
  ...
  "#anaRoot::before{content:'';position:fixed;inset:0 0 auto;height:124px;background:linear-gradient(180deg,rgba(11,23,48,1) 0%,rgba(11,23,48,.84) 62%,rgba(11,23,48,0) 100%);pointer-events:none;z-index:-1}",
  "#anaRoot .ana-in{max-width:1600px}",
  "#anaRoot .ana-top{margin:0 -24px 8px;padding:14px 24px 28px;min-height:86px;position:sticky;isolation:isolate;background:linear-gradient(180deg,rgba(11,23,48,.94) 0%,rgba(11,23,48,.78) 48%,rgba(11,23,48,.32) 78%,rgba(11,23,48,0) 100%);border:0;color:#fff;box-shadow:none;backdrop-filter:blur(15px) saturate(118%);-webkit-mask-image:linear-gradient(180deg,#000 0%,#000 62%,rgba(0,0,0,.76) 78%,transparent 100%);mask-image:linear-gradient(180deg,#000 0%,#000 62%,rgba(0,0,0,.76) 78%,transparent 100%)}",
  ...
  "#anaRoot .ana-top h1{font-size:22px;line-height:1.2;color:#fff;letter-spacing:.2px;text-shadow:0 2px 18px rgba(0,0,0,.16)}",
  ...
  "#anaRoot .hist-controls select,#anaRoot .hist-controls input[type=date]{min-width:150px;height:36px;padding:0 11px;background:#fff;border:1px solid var(--ana-line-strong);border-radius:9px;color:var(--ana-ink);font-family:inherit;font-size:12px;font-weight:700;cursor:pointer}",
  "#anaRoot .hist-control-label{display:flex;align-items:center;gap:6px;min-height:15px}",
  "#anaRoot .hist-help{position:relative;display:inline-flex}",
  "#anaRoot .hist-info{display:inline-grid;place-items:center;width:18px;height:18px;padding:0;border:1px solid #b9c7da;border-radius:50%;background:#fff;color:#476079;font:800 10px/1 inherit;cursor:help}",
  "#anaRoot .hist-tooltip{position:absolute;left:50%;bottom:calc(100% + 8px);z-index:12;width:340px;max-width:calc(100vw - 48px);padding:11px 12px;border:1px solid #cfdbeb;border-radius:9px;background:#10233f;color:#f5f8fc;font-size:10.5px;font-weight:600;line-height:1.65;letter-spacing:0;box-shadow:0 12px 30px rgba(16,35,63,.22);opacity:0;visibility:hidden;transform:translate(-18px,4px);transition:opacity .16s,transform .16s,visibility .16s;pointer-events:none}",
  "#anaRoot .hist-info:hover+.hist-tooltip,#anaRoot .hist-info:focus-visible+.hist-tooltip{opacity:1;visibility:visible;transform:translate(-18px,0)}",
  "#anaRoot .hist-shift>span,#anaRoot .hist-period>span{color:var(--ana-muted);font-size:9.5px;font-weight:900;letter-spacing:.35px}",
  "#anaRoot .hist-shift>div,#anaRoot .hist-period>div{display:flex;padding:2px;background:#e9eef5;border-radius:9px}",
  "#anaRoot .hist-shift button{min-width:52px;height:32px;padding:0 10px;border:0;border-radius:7px;background:transparent;color:var(--ana-muted);font-size:11px;font-weight:800;cursor:pointer}#anaRoot .hist-shift button.on{background:#fff;color:var(--ana-primary);box-shadow:0 2px 7px rgba(16,35,63,.12)}",
  ...
  "#anaRoot .hist-period.is-disabled{opacity:.48}#anaRoot .hist-period button:disabled{cursor:not-allowed;box-shadow:none}",
  "#anaRoot .hist-partial{flex-direction:row!important;align-items:center;gap:8px!important;min-height:56px;margin-left:auto;padding:0 10px;border:1px solid var(--ana-line);border-radius:9px;background:#fff;cursor:pointer}",
  ...
  "#anaRoot .hist-q-range{margin-left:auto;color:var(--ana-muted);font-size:10.5px}#anaRoot .hist-q-range.is-caution{color:#9a3412;font-weight:800}",
  ...
  "#anaRoot .hist-rank-actions{display:flex;align-items:center;gap:10px;margin-left:auto}#anaRoot .hist-rank #histRankCount{color:var(--ana-dim);font-size:9.5px;white-space:nowrap}",
  "#anaRoot .hist-rank-toggle{display:inline-flex;align-items:center;justify-content:center;gap:7px;min-height:36px;padding:0 11px;border:1px solid var(--ana-line-strong);border-radius:8px;background:#fff;color:var(--ana-ink);font-size:10.5px;font-weight:800;cursor:pointer}#anaRoot .hist-rank-toggle:hover{border-color:#9bb7e5;background:#f4f8ff;color:var(--ana-primary)}",
  "#anaRoot .hist-toggle-icon{display:inline-block;font-size:16px;line-height:1;transition:transform .16s}#anaRoot .hist-rank.is-open .hist-toggle-icon{transform:rotate(180deg)}#anaRoot #histRankPanel[hidden]{display:none}",
  ...
  "#anaRoot .hist-rank .hist-workshop-group th{padding:9px 12px;background:#edf4ff;border-top:1px solid #d9e6f8;border-bottom:1px solid #d9e6f8;color:#1b4f9b;text-align:left;font-size:10.5px;font-weight:900}#anaRoot .hist-workshop-group th small{margin-left:10px;color:#6f86a4;font-size:9px;font-weight:700}",
  ...
  "@media (max-width:820px){#anaRoot .hist-head{align-items:flex-start;flex-direction:column}#anaRoot .hist-static{align-self:flex-start}#anaRoot .hist-controls>*{flex:1 1 160px}#anaRoot .hist-controls select{width:100%;min-width:0;min-height:44px}#anaRoot .hist-partial{margin-left:0}#anaRoot .hist-q-range{width:100%;margin-left:0}#anaRoot .hist-insights{grid-template-columns:1fr}#anaRoot .hist-visual-grid{padding:10px 10px 0}#anaRoot .hist-rank,#anaRoot .hist-method{margin-left:10px;margin-right:10px}#anaRoot .ana-topic-head{align-items:flex-start;flex-direction:column}#anaRoot .hist-card-head{align-items:flex-start}#anaRoot .hist-rank-actions{flex-direction:column;align-items:flex-end;gap:6px}#anaRoot .hist-rank-toggle{min-height:44px}}",
  ...
  dateInput.onchange = function () {
    if (dateInput.value) { state.sel = null; load(dateInput.value); }
    if (window.PDTIIIHistoryModule && window.PDTIIIHistoryModule.setDate) window.PDTIIIHistoryModule.setDate(dateInput.value || "");
  };
