...
"#anaRoot .hc-modal #anaTable{max-width:560px;margin:0 auto}",
  ...
  "#anaRoot .ana-top{margin:0 -24px 8px;padding:14px 24px 22px;min-height:80px;background:linear-gradient(180deg,rgba(11,23,48,.99) 0%,rgba(11,23,48,.92) 60%,rgba(11,23,48,0) 100%);border:0;color:#fff;box-shadow:none;backdrop-filter:blur(12px)}",
