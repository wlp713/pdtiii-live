...
"#anaRoot .hc-modal #anaTable{max-width:560px;margin:0 auto}",
  ...
  "#anaRoot #histDate{min-width:184px}",
  ...
  "@media (max-width:820px){#anaRoot .hist-head{align-items:flex-start;flex-direction:column}#anaRoot .hist-static{align-self:flex-start}#anaRoot .hist-controls>*{flex:1 1 160px}#anaRoot .hist-controls select{width:100%;min-width:0}#anaRoot .hist-partial{margin-left:0}#anaRoot .hist-q-range{width:100%;margin-left:0}#anaRoot .hist-insights{grid-template-columns:1fr}#anaRoot .hist-visual-grid{padding:10px 10px 0}#anaRoot .hist-rank,#anaRoot .hist-method{margin-left:10px;margin-right:10px}#anaRoot .ana-topic-head{align-items:flex-start;flex-direction:column}#anaRoot .hist-card-head{align-items:flex-start}#anaRoot .hist-rank-actions{flex-direction:column;align-items:flex-end;gap:6px}#anaRoot .hist-rank-toggle{min-height:44px}}",
