...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    {
      ...
      "line": "RPO1·S系列",
      "time": "11:00-12:00",
      "problem_th": "เปลี่ยนรุ่นหัวไลน์FZ35L02>FZ35L01 /สายหลีดBK41440010 ไม่สามารถใช้ได้เปียกน้ำ ไลน์หยุดคลิ้ม-ท้ายไลน์ ทำStock s-coil ยกลงรถ นำงานReward มาทำงานออกไม่ต่อเนื่อง",
      "problem_zh": "线头换型FZ35L02→FZ35L01，BK41440010送料线遇水失效，导致线体停机。线尾S-coil库存需卸车转运，Reward工件投入生产，产出不连续。",
      "plan": 186,
      "actual": 113,
      "impact": -73
    },
    {
      ...
      "problem_zh": "中国人在In sert M-coil机台测试薄膜，导致H-series产出不连续。",
      "plan": 168,
      "actual": 131,
      "impact": -37
    },
    ...
    },
    {
      ...
      "problem_zh": "更换生产型号EZ80H1Y，未上线工作，等待M线圈点工作，仍在测试中。 1 台薄膜机，缓释，H 系列",
      "plan": 168,
      "actual": 73,
      "impact": -95
    },
    ...
    },
    {
      ...
      "problem_zh": "开启Slot工位 - 检查升降下降速率，F系列缝纫机线材频繁脱落。",
      "plan": 141,
      "actual": 78,
      "impact": -63
    },
    {
      ...
      "problem_zh": "DV泄漏检查点开工时，放行按钮损坏（08:00-08:20）（-100）已修复。机器人焊接柜工件来不及排出，初期未切割下料，因人员不足（-20），已安排支援人员。",
      "plan": 470,
      "actual": 350,
      "impact": -120
    },
    {
      ...
      "problem_zh": "等待冷却柜工作，无法及时冷却 TDC 机器未读取值，将工作向下提升 (-31) 的影响如下",
      "plan": 470,
      "actual": 439,
      "impact": -31
    },
  ...
  "problems_top": [
    {
      "name": "更换生产型号EZ80H1Y，未上线工作，等待M线圈点工作，仍在测试中。 1 台薄膜机，缓释，H 系列",
    ...
    {
      "name": "DV泄漏检查点开工时，放行按钮损坏（08:00-08:20）（-100）已修复。机器人焊接柜工件来不及排出，初期未切割下料，因人员不足（-20），已安排支援人员。",
      "name_th": "เริ่มงานจุดเช็ครั่ว DV ปุ่มกดปล่อยงานชำรุด (08:00-08:20) (-100) แก้ไขแล้ว งานระบายตู้เชื่อม robot ไม่ทัน ไม่ได้ตัดลงช่วง",
      "lines": [
        "PRO2·B"
      ],
      "times": [
