...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "NO2缝焊机（碰焊机）夹线臂卡滞无法复位，13:24停机，S系列线体。",
      "plan": 150,
      "actual": 163,
      "impact": 13
    },
    ...
    },
    {
      ...
      "problem_zh": "碰焊机D Pipe焊枪电线脱落，已修复（-21）。碰焊件掉落卡住升降机，在thrust gap PE检查点已处理（-30）。Air gap装配作业检查困难（-50），影响Rotor Line，作业卡滞不顺，导致冷却柜产出断续。",
      "plan": 430,
      "actual": 299,
      "impact": -131
    },
    {
      ...
      "problem_zh": "Air gap装配检查困难（-90），导致Rotor线作业不畅、卡顿，转子降温不及时，冷却柜出料延迟（-80），最终线压缩机上料焊接延迟200台。",
      "plan": 430,
      "actual": 260,
      "impact": -170
    },
    ...
    },
    {
      ...
      "problem_zh": "(-129) 新员工到岗(-30)，持续跟进提速技能培训。DV线Out端泄漏工件连续流出，影响(-100)B线Final工位。",
      "plan": 470,
      "actual": 341,
      "impact": -129
    },
    {
      ...
      "problem_zh": "(-69) DV泄漏件仍在陆续流出，属阀检前探伤工序件，影响(-69)阀室在B-Line Final线组装前的探伤检查。",
      "plan": 470,
      "actual": 401,
      "impact": -69
    },
    {
      ...
      "problem_zh": "(-87) DV泄漏件仍在陆续流出，影响(-35)工位。Stator螺栓头频繁滑丝，导致来料不连续。(-55)现主管正在处理，尝试重新打磨拧紧头端部。B线最终组装段。",
      "plan": 390,
      "actual": 303,
      "impact": -87
    },
    {
      ...
      "problem_zh": "(-89) DV泄漏件仍在陆续流出，影响(-60)启动按钮泄漏检查点脱落，(-30)已修复，B线Final。",
      "plan": 470,
      "actual": 381,
      "impact": -89
    },
    {
      ...
      "problem_zh": "(-125) DV泄漏件仍在陆续流出，影响(-30)。换型PA80HMD-YCL(WES#T)、EZ80H1Y-UXBL1(GET)，调整设备设定。",
      "plan": 470,
      "actual": 345,
      "impact": -125
    },
    {
      ...
      "problem_zh": "QA检查量规-22检测点时，请求IP协助制作通用检具，适用于所有机型。",
      "plan": 444,
      "actual": 422,
      "impact": -22
    }
  ...
  "problems_top": [
    {
      "name": "Air gap装配检查困难（-90），导致Rotor线作业不畅、卡顿，转子降温不及时，冷却柜出料延迟（-80），最终线压缩机上料焊接延迟200台。",
    ...
    {
      "name": "碰焊机D Pipe焊枪电线脱落，已修复（-21）。碰焊件掉落卡住升降机，在thrust gap PE检查点已处理（-30）。Air gap装配作业检查困难（-50），影响Rotor Line，作业卡滞不顺，导致冷却柜产出断续。",
    ...
    {
      "name": "(-129) 新员工到岗(-30)，持续跟进提速技能培训。DV线Out端泄漏工件连续流出，影响(-100)B线Final工位。",
