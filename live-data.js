...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "time": "11:00-12:00",
      "problem_th": "ซ้อมงานซาบิขึ้นไม่ครบช่องทำให้งานออกไม่ต่อเนื่อง H-series",
      "problem_zh": "碰焊工位作业不熟练，导致碰焊点未打满，H系列产品生产不连续。",
      "plan": 168,
      "actual": 127,
      "impact": -41
    },
    ...
    },
    {
      ...
      "problem_zh": "碰焊机D Pipe焊枪电线脱落，已修复（-21）。碰焊件掉落卡住升降机，thrust gap检查点PE已处理（-30）。Air gap检测作业困难（-50），影响Rotor线，作业卡滞不顺，导致冷却柜产品陆续流出。",
      "plan": 430,
      "actual": 299,
      "impact": -131
    },
    {
      ...
      "problem_zh": "Air gap装配作业检查困难（-90），导致Rotor线作业不畅、出现停顿，转子来不及降温，只能分批送入冷却柜（-80）。Final线分批将压缩机送上焊接工位，共200台。",
      "plan": 430,
      "actual": 260,
      "impact": -170
    },
    ...
    },
    {
      ...
      "problem_zh": "(-129) 新员工到岗(-30)，持续跟进加速技能熟练度。DV线Out工位漏检连续流出，影响(-100)B线Final工位。",
      "plan": 470,
      "actual": 341,
      "impact": -129
    },
    {
      ...
      "problem_zh": "(-69) DV泄漏件仍在陆续流出，属阀检前探伤工序件，导致(-69)阀室在B-Line Final组装前需先行探伤检查。",
      "plan": 470,
      "actual": 401,
      "impact": -69
    },
    {
      ...
      "problem_zh": "(-87) DV泄漏件仍在陆续流出，影响(-35)工位。Bolt Stator拧紧头频繁打滑，导致作业不连续，影响(-55)工位。现组长正尝试修磨拧紧头端部解决，B-Line Final。",
      "plan": 390,
      "actual": 303,
      "impact": -87
    },
    {
      ...
      "problem_zh": "(-89) DV泄漏件仍在陆续流出，影响(-60)工位Start按钮处泄漏检查点脱落，(-30)已修复，B线Final。",
      "plan": 470,
      "actual": 381,
      "impact": -89
    },
  ...
  "problems_top": [
    {
      "name": "(-129) 新员工到岗(-30)，持续跟进加速技能熟练度。DV线Out工位漏检连续流出，影响(-100)B线Final工位。",
    ...
    {
      "name": "Air gap装配作业检查困难（-90），导致Rotor线作业不畅、出现停顿，转子来不及降温，只能分批送入冷却柜（-80）。Final线分批将压缩机送上焊接工位，共200台。",
    ...
    {
      "name": "碰焊工位作业不熟练，导致碰焊点未打满，H系列产品生产不连续。",
