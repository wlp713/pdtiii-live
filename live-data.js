...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    {
      ...
      "problem_zh": "换型：线头FZ35L02→FZ35L01，BK41440010皮带沾水无法使用，导致停机。线尾至线头做S型线圈库存，卸货装车，Reward工件作业产出不连续。",
      "plan": 186,
      "actual": 113,
      "impact": -73
    },
    ...
    },
    {
      ...
      "problem_zh": "换型生产，调整S-coil位置并设定设备参数，等待线尾出件。",
      "plan": 168,
      "actual": 0,
      "impact": -168
    },
    ...
    },
    {
      ...
      "problem_zh": "DV泄漏检查点开工时，放行按钮损坏（08:00-08:20）（-100）已修复。机器人焊接柜工件来不及排出，初期未切割，因人员不足（-20），已安排支援人员。",
      "plan": 470,
      "actual": 350,
      "impact": -120
    },
  ...
  "problems_top": [
    ...
    {
      "name": "换型生产，调整S-coil位置并设定设备参数，等待线尾出件。",
      "lines": [
        "RPO1·H系列"
      ],
      "times": [
    ...
    {
      "name": "DV泄漏检查点开工时，放行按钮损坏（08:00-08:20）（-100）已修复。机器人焊接柜工件来不及排出，初期未切割，因人员不足（-20），已安排支援人员。",
      "lines": [
        "PRO2·B"
      ],
      "times": [
