...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "PE上班时发现碰焊机弹出报警，进入焊接房前碰焊机无法使用（-20），已调整机器人设定修复管路角度。",
      "plan": 430,
      "actual": 387,
      "impact": -43
    },
    ...
    },
    {
      ...
      "problem_zh": "(-52) 换型 KE90HME-YCL(SCER#T) → PZ99HMC-KCL(SRT#T)，调整设备设定(-52) B线最终段。",
      "plan": 390,
      "actual": 338,
      "impact": -52
    },
    {
      ...
      "problem_zh": "(-87) 重新调整pipe cover B碰焊参数(-50) 电阻检测机频繁报警(-37) 已重新校准插头",
      "plan": 470,
      "actual": 383,
      "impact": -87
    },
