...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "Laser-2打标机维修中（PE已介入处理，但运行仍不稳定）。",
      "plan": 444,
      "actual": 442,
      "impact": -2,
      "shift": "day"
  ...
  "problems_top": [
    ...
    {
      "name": "Laser-2打标机维修中（PE已介入处理，但运行仍不稳定）。",
      "name_th": "แก้ไขเครื่องมาร์ค Laser-2(PE เข้าแก้ไขยังใช้งานไม่เสถียร)",
      "lines": [
        "PRO2·C"
      ],
      "times": [
