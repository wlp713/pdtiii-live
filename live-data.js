...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "TDC设备读不到数值，Line out 14号机台(-26)。已重新校准设备，碰焊处卡在冷却出口传感器位置，检查碰焊位置后重新调整设定为(-30)。定子螺栓拧紧头滑牙，已更换新件。",
      "plan": 470,
      "actual": 389,
      "impact": -81
    },
    ...
    },
    {
      ...
      "problem_zh": "接1班，COVER B-22拧紧机已修复（完成）。",
      "plan": 444,
      "actual": 422,
      "impact": -22
    }
  ...
  "problems_top": [
    ...
    {
      "name": "TDC设备读不到数值，Line out 14号机台(-26)。已重新校准设备，碰焊处卡在冷却出口传感器位置，检查碰焊位置后重新调整设定为(-30)。定子螺栓拧紧头滑牙，已更换新件。",
    ...
    {
      "name": "Rotor Line 自动阀组装机螺栓拧不进去，主管已处理，导致冷却柜产品陆续流出。",
