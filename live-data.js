...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "碰焊机D Pipe焊枪电线脱落，已修复（-21）。碰焊件掉落卡住升降机，在thrust gap PE检查点已处理（-30）。Air gap装配作业检查困难（-50），影响Rotor Line，作业卡滞不顺，导致冷却柜产品陆续流出。",
      "plan": 430,
      "actual": 299,
      "impact": -131
    },
    {
      ...
      "problem_zh": "Air gap 装配作业检查困难（-90），导致 Rotor 线作业不畅、出现停顿，转子降温不及时，工件陆续送进冷却柜（-80）。Final 线陆续将压缩机上线碰焊 200 台。",
      "plan": 430,
      "actual": 260,
      "impact": -170
    },
    {
      ...
      "problem_zh": "(-129) 新员工到岗(-30)，持续跟进提速技能。DV线Out工位泄漏件连续流出，影响(-100)B线Final工位。",
      "plan": 470,
      "actual": 341,
      "impact": -129
    },
    {
      ...
      "problem_zh": "(-69) DV泄漏件仍在陆续流出，属照灯检查阀门前工序件，影响(-69)阀室在装配线前照灯检查阀门的作业。",
      "plan": 470,
      "actual": 401,
      "impact": -69
    }
  ...
  "problems_top": [
    {
      "name": "Air gap 装配作业检查困难（-90），导致 Rotor 线作业不畅、出现停顿，转子降温不及时，工件陆续送进冷却柜（-80）。Final 线陆续将压缩机上线碰焊 200 台。",
    ...
    {
      "name": "(-129) 新员工到岗(-30)，持续跟进提速技能。DV线Out工位泄漏件连续流出，影响(-100)B线Final工位。",
    ...
    {
      "name": "WIP库存不足，导致生产不连续。",
      "name_th": "Stock Wip มีน้อยทำให้งานออกไม่ต่อเนื่อง",
      "lines": [
        "RPO1·H系列",
        "RPO1·WL系列"
      ],
