...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "Rotor Line 自动阀组装机螺栓拧不进去，主管已处理，导致工件陆续流向冷却柜工位。",
      "plan": 430,
      "actual": 369,
      "impact": -61
    },
    ...
    },
    {
      ...
      "problem_zh": "(-36) 3号焊接机无法使用，导致工件排出不连续。\n(-20) 逐步削减焊接前堆积的工件，Final线首端升降机不动作。\n(-20) 班组长已处理，B线Final传感器未感应到。",
      "plan": 470,
      "actual": 434,
      "impact": -36
    },
    {
      ...
      "problem_zh": "(-34) 装Air Gab作业导致来料不连续(-20) Pro.1已派员工在组装前整理Stator线包，但#3焊接机柜仍无法使用，需在焊接前逐步切料(-20) B线最终组装",
      "plan": 390,
      "actual": 356,
      "impact": -34
    },
    {
      ...
      "problem_zh": "(-80) 装Air Gab作业导致来料不连续(-40) Pro.1派员工整理Stator后再组装，碰焊柜#3仍无法使用，碰焊前需分批切割作业(-40) Final线",
      "plan": 470,
      "actual": 390,
      "impact": -80
    },
    {
      ...
      "line": "PRO2·B",
      "time": "13:00-14:00",
      "problem_th": "(-60) เครื่องเช็คความต้านทานAlramเนื่องจากหัวเช็คเข้าไม่ตรงทำการปรับระยะ (-25) ตู้เชื่อม#3 ยังใช้งานไม่ได้ ทะยอยตัดงานก่อนเชื่อม",
      "problem_zh": "(-60) 绝缘电阻检测机报警，因检测头未对正，已调整间距。(-25) 焊接柜#3仍无法使用，先分选切割件再焊接。",
      "plan": 470,
      "actual": 410,
      "impact": -60
    },
  ...
  "problems_top": [
    ...
    {
      "name": "(-60) 绝缘电阻检测机报警，因检测头未对正，已调整间距。(-25) 焊接柜#3仍无法使用，先分选切割件再焊接。",
      "name_th": "(-60) เครื่องเช็คความต้านทานAlramเนื่องจากหัวเช็คเข้าไม่ตรงทำการปรับระยะ (-25) ตู้เชื่อม#3 ยังใช้งานไม่ได้ ทะยอยตัดงานก่",
      "lines": [
        "PRO2·B"
      ],
      "times": [
