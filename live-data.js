...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    {
      ...
      "problem_zh": "INSERT S-coil机转盘定位不准，导致INSERT杆件时杆件弯曲/转盘不复位，PE自08:20起正在修复。S系列。",
      "plan": 169,
      "actual": 132,
      "impact": -37,
      "shift": "day"
    ...
    },
    {
      ...
      "problem_zh": "看板计数，08:00-08:35停机，M点Coil轨道不放料；08:00-08:34停机，Slot设备上料机构不动作；08:00-08:45停机，加热器缝焊机不发热；08:00-08:25停机，F系列。",
      "plan": 141,
      "actual": 56,
      "impact": -85,
      "shift": "day"
    },
    {
      ...
      "line": "RPO1·F系列",
      "time": "10:00-11:00",
      "problem_th": "เครื่อง Winding  S Coil ไม่ตรงตำแหน่ง หยุด09:12 -10:35 เครื่องเย็บ ฮิตตอร์ขาดหยุด10:58 กำลังแก้ไข",
      "problem_zh": "绕线机S线圈位置偏移，09:12-10:35停机；缝焊机加热器损坏，10:58停机，正在修复。",
      "plan": 141,
      "actual": 90,
      "impact": -51,
      "shift": "day"
    },
    {
      ...
      "problem_zh": "S系列管路整形困难，组长支援(-47)。Rotor烘干机滴水（等待P/E期间，先堆料再投Rotor），导致Final出料不连续(-30)。IP介入调整夹紧设定，将Cover B拧紧至正确位置(-30)。A线Final。",
      "plan": 431,
      "actual": 324,
      "impact": -107,
      "shift": "day"
    },
    {
      ...
      "problem_zh": "1. 输送轨道Low位碰焊处卡滞（PE已处理）（-28），TDC设备读不到数值，工件陆续进入冷却柜，需停机等待温度（-40）。\n2. A线最终组装工序。",
      "plan": 431,
      "actual": 363,
      "impact": -68,
      "shift": "day"
    },
    {
      ...
      "problem_zh": "A线终检工位KV&MΩ检测机频繁报警（IP正在排查中）（-59）",
      "plan": 359,
      "actual": 300,
      "impact": -59,
      "shift": "day"
    ...
    },
    {
      ...
      "problem_zh": "换型1次-30台，进入电阻检测机(工位51)维修（已修但未解决）。",
      "plan": 370,
      "actual": 289,
      "impact": -81,
      "shift": "day"
    },
    {
      ...
      "problem_zh": "绝缘电阻测试仪故障，无法使用，PE线导致设备停机维修。",
      "plan": 444,
      "actual": 184,
      "impact": -260,
      "shift": "day"
  ...
  "problems_top": [
    {
      "name": "绝缘电阻测试仪故障，无法使用，PE线导致设备停机维修。",
    ...
    {
      "name": "KV&MΩ检测机频繁报警，Out线连续报警（IP及中方人员正在处理中）。",
      "name_th": "เครื่องเช็ค KV&MΩ Alarm บ่อย line Out ต่อเนื่อง(IP และคนจีนกำลังเข้าแก้ไข)",
      "lines": [
        "PRO2·A"
      ],
      "times": [
