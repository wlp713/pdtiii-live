...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "(-36) 焊接机#3故障，导致工件排出不连续；(-20) 逐步削减焊接前积压工件，Final线首升降机不动作；(-20) 班组长已处理，B线Final传感器未触发。",
      "plan": 470,
      "actual": 434,
      "impact": -36
    },
    {
      ...
      "problem_zh": "(-34) 安装Air Gab作业导致来料不连续；(-20) Pro.1已派员工整理Stator入组装前工序，但#3焊接机仍无法使用，需在焊接前逐步分拣工件。",
      "plan": 390,
      "actual": 356,
      "impact": -34
    },
    ...
    },
    {
      ...
      "problem_zh": "继1班后，已修复B-22盖板拧紧机（已处理完毕）。",
      "plan": 444,
      "actual": 422,
      "impact": -22
    }
  ...
  "problems_top": [
    ...
    {
      "name": "(-36) 焊接机#3故障，导致工件排出不连续；(-20) 逐步削减焊接前积压工件，Final线首升降机不动作；(-20) 班组长已处理，B线Final传感器未触发。",
