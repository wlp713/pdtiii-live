...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    {
      ...
      "problem_zh": "S系列捆扎机夹绳机构卡滞，导致作业中断、产出不连续。",
      "plan": 150,
      "actual": 125,
      "impact": -25
    },
    ...
    },
    {
      ...
      "problem_zh": "H系列碰焊作业上料未满槽，导致产出不连续。",
      "plan": 168,
      "actual": 133,
      "impact": -35
    },
    {
      ...
      "line": "RPO1·H系列",
      "time": "11:00-12:00",
      "problem_th": "ซ้อมงานซาบิขึ้นไม่ครบช่องทำให้งานออกไม่ต่อเนื่อง",
      "problem_zh": "碰焊工序上料不到位，导致工件不连续。",
      "plan": 168,
      "actual": 127,
      "impact": -41
    },
    ...
    },
    {
      ...
      "problem_zh": "碰焊机D Pipe焊枪电线脱落，已修复（-21）。碰焊件掉落卡住升降机，thrust gap检查点PE已处理（-30）。Air gap检测作业困难（-50），影响Rotor线作业不畅、断续，导致冷却柜产品陆续流出。",
      "plan": 430,
      "actual": 299,
      "impact": -131
    },
    {
      ...
      "problem_zh": "Air gap 装配作业检查困难（-90），导致 Rotor 线作业不畅、出现停顿，转子降温不及时，冷却柜分批出料（-80）；Final 线分批将压缩机上线碰焊 200 台。",
      "plan": 430,
      "actual": 260,
      "impact": -170
    },
    ...
    },
    {
      ...
      "time": "11:00-12:00",
      "problem_th": "ปกต",
      "problem_zh": "“ปกติ”单独出现时，通常表示“正常/平时”。结合压缩机工厂语境，可译为：**正常**（指设备或作业处于常规状态）。若为汇报异常前的铺垫，可译为：**平时/正常情况下**。",
      "plan": 430,
      "actual": 445,
      "impact": 15
    },
    {
      ...
      "problem_zh": "(-129) 新员工到岗(-30)，持续跟进加速技能熟练度。DV线Out工位漏作业连续流出，影响(-100) B线Final。",
      "plan": 470,
      "actual": 341,
      "impact": -129
    },
    {
      ...
      "problem_zh": "(-69) DV泄漏件仍在陆续流出，属阀检前工序，导致(-69)阀室在进入B-Line Final前组装前需先做阀检，影响生产连续性。",
      "plan": 470,
      "actual": 401,
      "impact": -69
    },
    {
      ...
      "problem_zh": "(-87) DV泄漏件仍在陆续流出，影响(-35)工位。Stator螺栓头频繁滑牙，导致作业不连续。(-55)现主管正尝试重新打磨拧紧头端部解决，B线最终组装段。",
      "plan": 390,
      "actual": 303,
      "impact": -87
    },
    {
      ...
      "line": "PRO2·B",
      "time": "11:00-12:00",
      "problem_th": "(-89) งานรั่ว DV ยังทะยอยออก ส่งผลกระทบ (-60) ปุ่ม Start จุดเช็ครั่วหลุด (-30) แก้ไขแล้ว",
      "problem_zh": "(-89) DV泄漏件仍在陆续流出，影响(-60)工位Start按钮泄漏检查点脱落，(-30)已修复。",
      "plan": 470,
      "actual": 381,
      "impact": -89
    }
  ...
  "problems_top": [
    {
      "name": "(-129) 新员工到岗(-30)，持续跟进加速技能熟练度。DV线Out工位漏作业连续流出，影响(-100) B线Final。",
    ...
    {
      "name": "Air gap 装配作业检查困难（-90），导致 Rotor 线作业不畅、出现停顿，转子降温不及时，冷却柜分批出料（-80）；Final 线分批将压缩机上线碰焊 200 台。",
    ...
    {
      "name": "碰焊工序上料不到位，导致工件不连续。",
      "name_th": "ซ้อมงานซาบิขึ้นไม่ครบช่องทำให้งานออกไม่ต่อเนื่อง",
      "lines": [
        "RPO1·H系列"
      ],
      "times": [
