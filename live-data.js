...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    {
      ...
      "problem_zh": "换线：机头型号FZ35L02→FZ35L01，BK41440010送料线遇水无法使用，导致停机。线头至线尾做S型线圈库存，卸车搬运，Reward工件投入生产，S系列产出不连续。",
      "plan": 186,
      "actual": 113,
      "impact": -73
    },
    ...
    },
    {
      ...
      "problem_zh": "换产S-coil，调整设备设定，等H系列线尾出件。",
      "plan": 168,
      "actual": 0,
      "impact": -168
    },
    ...
    },
    {
      ...
      "problem_zh": "开启Slot工位 - 检查下料率，F系列缝焊机焊丝脱落频繁。",
      "plan": 141,
      "actual": 78,
      "impact": -63
    },
    {
      ...
      "problem_zh": "DV泄漏检查点开工，放行按钮损坏（08:00-08:20）（-100件）已修复。机器人焊接柜来不及排出，初期未切割，因人员不足（-20件），已安排支援人员。",
      "plan": 470,
      "actual": 350,
      "impact": -120
    },
    {
      ...
      "problem_zh": "等待冷却柜制冷不及时，受TDC设备读不到数值影响，工件下线（-31件），持续跟进中。",
      "plan": 470,
      "actual": 439,
      "impact": -31
    },
    {
      ...
      "problem_zh": "碰焊机报警-10：MUF盖板B螺栓拧入不正，导致设备报警（-10）。已重新调整位置设定修复。",
      "plan": null,
      "actual": null,
      "impact": null
    },
    ...
    },
    {
      ...
      "problem_zh": "冷却柜卡滞，库存件已投入组装（PE正在处理中）。",
      "plan": 370,
      "actual": 397,
      "impact": 27
    },
  ...
  "problems_top": [
    ...
    {
      "name": "换线：机头型号FZ35L02→FZ35L01，BK41440010送料线遇水无法使用，导致停机。线头至线尾做S型线圈库存，卸车搬运，Reward工件投入生产，S系列产出不连续。",
