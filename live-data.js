...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "NO2碰焊机夹线臂卡滞无法复位，13:24停机，S系列线体。",
      "plan": 150,
      "actual": 163,
      "impact": 13
    },
    {
      ...
      "problem_zh": "NO2缝焊机（碰焊）夹线臂卡滞无法复位，停机13:24-14:35。",
      "plan": 125,
      "actual": 114,
      "impact": -11
    },
    ...
    },
    {
      ...
      "line": "RPO1·H系列",
      "time": "14:00-15:00",
      "problem_th": "เปลี่ยนรุ่นใช้เวลาปรับเครื่องจักร25นาที",
      "problem_zh": "换型调机耗时25分钟。",
      "plan": 144,
      "actual": 77,
      "impact": -67
    },
    ...
    },
    {
      ...
      "problem_zh": "Air gap装配作业检查困难（-90），导致Rotor线作业不畅、出现停顿，转子降温不及时，冷却柜出料延迟（-80）。总装线只能分批将压缩机送上碰焊，共200台。",
      "plan": 430,
      "actual": 260,
      "impact": -170
    },
    ...
    },
    {
      ...
      "problem_zh": "PE已进入维修D Pipe焊接机（-127），因Air gap卡滞导致检查困难。",
      "plan": 430,
      "actual": 243,
      "impact": -187
    },
    {
      ...
      "problem_zh": "(-129) 新员工到岗(-30)，持续跟进提速技能培训。DV线Out工位漏工序问题连续发生，影响(-100)B线Final工位。",
      "plan": 470,
      "actual": 341,
      "impact": -129
    },
    {
      ...
      "problem_zh": "(-69) DV泄漏件仍在陆续流出，属阀检前工序，导致(-69)阀室在进入B-Line Final前组装工位前需先做阀检，影响产线连续性。",
      "plan": 470,
      "actual": 401,
      "impact": -69
    },
    {
      ...
      "problem_zh": "(-87) DV泄漏件仍在陆续流出，影响(-35)工位。Stator螺栓头频繁滑丝，导致来料不连续。(-55)现主管已尝试修磨拧紧头端部处理，B线最终工位。",
      "plan": 390,
      "actual": 303,
      "impact": -87
    },
    {
      ...
      "problem_zh": "(-89) DV泄漏件仍陆续流出，影响(-60)启动按钮泄漏检查点脱落，(-30)已修复，B线终检。",
      "plan": 470,
      "actual": 381,
      "impact": -89
    },
    {
      ...
      "problem_zh": "(-125) DV泄漏件仍在陆续流出，影响(-30)换型PA80HMD-YCL(WES#T) EZ80H1Y-UXBL1(GET)，调整设备设定(-95) B线Final。",
      "plan": 470,
      "actual": 345,
      "impact": -125
    },
    {
      ...
      "problem_zh": "(-109) QA培训焊接工序员工管道焊接点检标准\n(-55) Test Run设备压力报警频繁，原因为橡胶件磨损，已修复",
      "plan": 470,
      "actual": 361,
      "impact": -109
    },
    {
      ...
      "problem_zh": "QA检查量规-22检测点时，请求IP协助制作适用于所有型号的检具。",
      "plan": 444,
      "actual": 422,
      "impact": -22
    },
  ...
  "problems_top": [
    {
      "name": "PE已进入维修D Pipe焊接机（-127），因Air gap卡滞导致检查困难。",
    ...
    {
      "name": "(-129) 新员工到岗(-30)，持续跟进提速技能培训。DV线Out工位漏工序问题连续发生，影响(-100)B线Final工位。",
