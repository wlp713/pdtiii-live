...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "Rotor Line生产SZ59F1E-9YEL型号时，工件卡滞并连续停顿，导致冷却柜出货延误。",
      "plan": 430,
      "actual": 375,
      "impact": -55
    },
    {
      ...
      "problem_zh": "Rotor Line 自动阀组装机螺栓拧不进去，主管已处理，导致工件陆续流出至冷却柜工位。",
      "plan": 430,
      "actual": 369,
      "impact": -61
    },
    ...
    },
    {
      ...
      "problem_zh": "(-36) 焊机#3故障，导致工件排出不连续；(-20) 逐步削减焊接前堆积工件，Final线首升降机不动作；(-20) 班组长已处理，B线Final传感器不感应。",
      "plan": 470,
      "actual": 434,
      "impact": -36
    },
    {
      ...
      "problem_zh": "(-34) 装Air Gab作业导致来料不连续(-20) Pro.1已派人先整理Stator再组装，但#3焊接机仍无法使用，需在焊接前分批切料(-20) B线最终组装",
      "plan": 390,
      "actual": 356,
      "impact": -34
    },
    ...
    },
    {
      ...
      "problem_zh": "(-60) 绝缘电阻检测机报警，因检测头未对正，已调整间距。(-25) 焊接柜#3仍无法使用，先分批切割再焊接。",
      "plan": 470,
      "actual": 410,
      "impact": -60
    },
    ...
    },
    {
      ...
      "problem_zh": "继1班后，B-22盖板拧紧机已修复（完成）。",
      "plan": 444,
      "actual": 422,
      "impact": -22
    }
  ...
  "problems_top": [
    ...
    {
      "name": "(-60) 绝缘电阻检测机报警，因检测头未对正，已调整间距。(-25) 焊接柜#3仍无法使用，先分批切割再焊接。",
