...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "碰焊机D Pipe焊枪电线脱落，已修复（-21）。碰焊件掉落卡住升降机，thrust gap检查点PE已处理（-30）。Air gap装配检查困难（-50），影响Rotor Line作业不畅、卡顿，导致冷却柜产品陆续流出。",
      "plan": 417,
      "actual": 299,
      "impact": -118
    },
    {
      ...
      "problem_zh": "(-129) 新员工进入岗位(-30)，持续跟进加速技能熟练度。DV线体流出漏检品连续流出，影响(-100) B线最终组装。",
      "plan": 470,
      "actual": 341,
      "impact": -129
    },
    {
      ...
      "problem_zh": "(-69) DV泄漏件仍在陆续流出，属阀检透光前工序，导致(-69)阀室在进线组装前需先做透光检查。",
      "plan": 470,
      "actual": 401,
      "impact": -69
    }
  ...
  "problems_top": [
    {
      "name": "(-129) 新员工进入岗位(-30)，持续跟进加速技能熟练度。DV线体流出漏检品连续流出，影响(-100) B线最终组装。",
    ...
    {
      "name": "碰焊机D Pipe焊枪电线脱落，已修复（-21）。碰焊件掉落卡住升降机，thrust gap检查点PE已处理（-30）。Air gap装配检查困难（-50），影响Rotor Line作业不畅、卡顿，导致冷却柜产品陆续流出。",
