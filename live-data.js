...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "碰焊机启动4台可用，逐步切割积压待焊工件（-22件），影响Rotor线。Micro jig量具用于测量Crankcase已磨损，导致测量精度不良，产生NG件。IP介入检查，等待Final期间将压缩机上机焊接（-120件）。KV检测机频繁报警，已停机20套。",
      "plan": 430,
      "actual": 288,
      "impact": -142
    },
    ...
    },
    {
      ...
      "problem_zh": "(-55) 将急出货SZ40F1E-9KBL工件优先上线焊接，并削减已投产任务，需调整(-55) B-Line Final焊接设备设定。",
      "plan": 470,
      "actual": 415,
      "impact": -55
    },
    ...
    },
    {
      ...
      "line": "PRO2·B",
      "time": "11:00-12:00",
      "problem_th": "(-119) งานติด Air Gab ต้องกระแทกจัดทรง Stator ก่อนเข้าประกอบ ทำให้ งานออกไม่ต่อเนื่อง(-70) นำงานเร่งส่งรุ่น SZ40F1E-9KBL ขึ้นเชื่อม และตัดงานที่ผลิตลง งานจึงออกไม่ต่อเนื่อง",
      "problem_zh": "(-119) Air Gab装配前需先碰焊整形Stator，导致作业不连续。(-70) 为赶产SZ40F1E-9KBL，将急件优先焊接并削减产量，作业连续性受影响。",
      "plan": 470,
      "actual": 351,
      "impact": -119
    },
    ...
    },
    {
      ...
      "problem_zh": "Gap装配作业来料不连续，线上库存已耗尽。",
      "plan": 370,
      "actual": 362,
      "impact": -8
    },
  ...
  "problems_top": [
    {
      "name": "(-119) Air Gab装配前需先碰焊整形Stator，导致作业不连续。(-70) 为赶产SZ40F1E-9KBL，将急件优先焊接并削减产量，作业连续性受影响。",
