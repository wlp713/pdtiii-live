...
window.__LIVE_DATA__ = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "problem_zh": "S-COL设备故障，维修耗时40分钟，导致大量NG品流出，S系列生产中断不连续。",
      "plan": 186,
      "actual": 97,
      "impact": -89
    },
    {
      ...
      "problem_zh": "M coil下线作业练习（线尾有WIP，H系列可连续产出）",
      "plan": 168,
      "actual": 175,
      "impact": 7
    },
    ...
    },
    {
      ...
      "time": "11:00-12:00",
      "problem_th": "ซ้อมงานที่ออกจากเครื่องm coilทำให้งานออกไม่ต่อเนื่อง H-series",
      "problem_zh": "H系列m coil出料卡滞，导致作业不连续。",
      "plan": 168,
      "actual": 113,
      "impact": -55
    },
    ...
    },
    {
      ...
      "time": "14:00-15:00",
      "problem_th": "ซ้อมงานที่ออกจากเครื่องm coilทำให้งานออกไม่ต่อเนื่อง H-series",
      "problem_zh": "H系列m coil出料口作业卡滞，导致生产连续性中断。",
      "plan": 144,
      "actual": 81,
      "impact": -63
    },
    ...
    },
    {
      ...
      "problem_zh": "末线压机自动运行故障，维修20分钟未解决。停机拆下计数器转装到检电设备上，导致末线无产量输出。",
      "plan": 141,
      "actual": 162,
      "impact": 21
    },
    {
      ...
      "problem_zh": "PE和IP已介入处理test run(-20)碰焊抬升销问题，影响Rotor Line Piston，型号SZ40F1E-9KBL。工件与班组不匹配，初步对策为更换CRANKCASE班组，并要求Piston与作业班组对应，导致Rotor降温来不及，工件陆续流出至Final。",
      "plan": 430,
      "actual": 364,
      "impact": -66
    },
    ...
    },
    {
      ...
      "problem_zh": "(-40) 泄漏作业，DV=22，设定(-22)。1号机Test Run时插头不对位，导致设备频繁报警。(-20)已重新设定等级，B线Final。",
      "plan": 470,
      "actual": 430,
      "impact": -40
    },
    ...
    },
    {
      ...
      "problem_zh": "(-47) TDC设备读数频繁异常，工件陆续进入冷却柜，降温来不及，导致工件供应不连续。\n(-25) Conveyer线断电，因断路器跳闸。\n(-25) B线Final工位。",
      "plan": 470,
      "actual": 423,
      "impact": -47
    },
    {
      ...
      "problem_zh": "(-33) 线头升降机不动作，因传感器未触发。(-33) B线最终工位。",
      "plan": 470,
      "actual": 437,
      "impact": -33
    },
    {
      ...
      "problem_zh": "(-116) Air Gab Ng工序导致作业不连续；(-116) Pro.1派员工过来敲击整形后，B线最终工位（问题解决）。",
      "plan": 470,
      "actual": 354,
      "impact": -116
    },
    {
      ...
      "problem_zh": "(-34) 作业来料不连续，Stator需先敲击整形才能进入组装。\n(-20) Cover B设备拧紧不正，已重新设定拧紧距离。",
      "plan": 390,
      "actual": 356,
      "impact": -34
    },
