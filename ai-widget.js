...
(function () {
  ...
  function buildUI() {
    ...
    style.textContent = "" +
      ...
      ".ai-chat{display:flex;flex-direction:column;min-width:0;min-height:0;background:#fbfcfe}.ai-chat-intro{padding:19px 22px 12px;border-bottom:1px solid #e8edf5;background:#fff}.ai-chat-intro h3{margin:4px 0 3px;font-size:17px;line-height:1.25}.ai-chat-intro p{margin:0;color:var(--ai-muted);font-size:11px}.ai-messages{flex:1;min-height:0;overflow-y:auto;padding:16px 22px 20px}.ai-message{display:flex;gap:9px;align-items:flex-start;margin:0 0 13px;animation:aiMsgIn .2s ease-out}.ai-message.user{flex-direction:row-reverse}.ai-message-avatar{display:grid;place-items:center;flex:0 0 26px;width:26px;height:26px;border-radius:9px;background:#dbe9fb;color:var(--ai-blue);font-size:10px;font-weight:900}.ai-message.user .ai-message-avatar{background:#1d5fd1;color:#fff}.ai-message-body{max-width:min(78%,620px)}.ai-message-meta{margin:1px 0 4px;color:#8a9ab0;font-size:9px;font-weight:800}.ai-message.user .ai-message-meta{text-align:right}.ai-message-bubble{padding:10px 12px;border:1px solid #e0e7f1;border-radius:4px 13px 13px 13px;background:#fff;color:#28384e;font-size:12.5px;line-height:1.65;white-space:pre-wrap;word-break:break-word;box-shadow:0 3px 10px rgba(31,58,96,.04)}.ai-message.user .ai-message-bubble{border:0;border-radius:13px 4px 13px 13px;background:#1d5fd1;color:#fff}.ai-composer{padding:12px 16px 14px;border-top:1px solid var(--ai-line);background:#fff}.ai-composer-box{display:flex;align-items:flex-end;gap:9px;padding:6px;border:1px solid #cbd8e8;border-radius:13px;background:#f9fbfe;transition:border-color .15s,box-shadow .15s}.ai-composer-box:focus-within{border-color:#83a9e7;box-shadow:0 0 0 3px rgba(53,110,209,.1)}.ai-composer textarea{flex:1;min-height:42px;max-height:110px;resize:none;border:0;outline:0;background:transparent;padding:8px 8px;color:var(--ai-ink);font-size:12.5px;line-height:1.5}.ai-composer textarea::placeholder{color:#94a3b8}.ai-icon-btn,.ai-send-btn{display:grid;place-items:center;flex:0 0 40px;width:40px;height:40px;border-radius:10px;cursor:pointer}.ai-icon-btn{border:1px solid #d2ddea;background:#fff;color:#506b8d;font-size:17px}.ai-icon-btn:hover{background:#eef4ff;color:var(--ai-blue)}.ai-send-btn{border:0;background:#1d5fd1;color:#fff;font-size:17px}.ai-send-btn:hover{background:#164ba8;transform:translateY(-1px)}.ai-compose-hint{margin:6px 4px 0;color:#9aa9bc;font-size:9.5px}.ai-compose-hint kbd{padding:1px 4px;border:1px solid #d4dce8;border-radius:4px;background:#f4f6f9;font-family:inherit}" +
  ...
  function addMsg(text, who) {
    ...
    d.querySelector(".ai-message-bubble").textContent = text;
    m.appendChild(d);
