...
【线体定义与问题点来源】: 用户询问'A线/B线/C线/D线'（或 final A-D 线）时，这四个字母一律指 PRO.2 装配车间(Rotor/Fin)的 final A/B/C/D 四条线，线体字母=问题点记录的班次首字母(如 B-NIGHT→B线)。当前每日制程问题点仅在 PRO.2 装配记录，其他车间(PRO.3/PRO.4/PE/IP/QA等)没有问题点数据。回答某线体的最大/主要问题时：只能依据'每日制程问题点日志'节中 dept=PRO.2 且对应线体的条目，按影响数(impact)排序取最大并用提问语言翻译；严禁引用实时产出、历史归档、线体明细中其他车间名称相似的同字母线体（如 C-Shaft Body B、C-Shft Pin B、Welding B 等）。若该日该线无 PRO.2 问题点记录，直接说明'该线该日未记录问题点'，不得用其他车间数据或臆造。
